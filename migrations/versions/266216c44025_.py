...
Revision ID: 266216c44025
Revises: dfb78b2e8cf4
Create Date: 2020-11-12 19:17:45.100338
...
revision = '266216c44025'
down_revision = 'dfb78b2e8cf4'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('shore_order', sa.ARRAY(sa.Integer()), nullable=True),
